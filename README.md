...
基于FastAPI + Vue3 + PostgreSQL构建的AI法律咨询系统，为企业提供智能法律咨询服务。

## 🎯 项目概述

**AI 法律咨询系统**是一个面向企业的智能法律服务平台，通过 AI 大模型技术结合专业法律知识库，为企业提供实时法律咨询、合同风险诊断、合规调查等一站式法律服务。系统采用前后端分离架构，支持云端与本地 AI 模型，确保数据安全与响应效率。
...
| 多轮对话示例 | 模型切换界面 |
|--------------|--------------|
| ![多轮对话](./picture/法律咨询02.png) | ![模型切换](./picture/法务咨询03.png) |
...
- 向量化存储支持语义检索
- 与合同诊断功能深度集成，提供精准风险识别

### 咨询历史管理
![咨询历史界面](./picture/咨询历史.png)
